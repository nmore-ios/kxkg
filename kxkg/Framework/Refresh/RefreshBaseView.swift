...
let RefreshLabelTextColor:UIColor = UIColor(red: 229/255, green: 1/255, blue: 82/255, alpha:1)
//(red: 150.0/255, green: 150.0/255.0, blue: 150.0/255.0, alpha: 1)
...
class RefreshBaseView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        activityView.color=UIColor(red: 229/255, green: 1/255, blue: 82/255, alpha:1)
    ...
    override func layoutSubviews() {
        ...
        self.arrowImage.center = CGPointMake(arrowX, self.frame.size.height/2)
        //指示器
