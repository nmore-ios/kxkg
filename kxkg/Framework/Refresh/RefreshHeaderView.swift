...
class RefreshHeaderView: RefreshBaseView {
    class func footer()->RefreshHeaderView{
        let footer:RefreshHeaderView  = RefreshHeaderView(frame: CGRectMake(0, 0,   UIScreen.mainScreen().bounds.width,  CGFloat(64)))
        return footer
    }
...
//    var lastUpdateTimeLabel:UILabel!
    ...
    override init(frame: CGRect) {
        ...
        backImage.image=UIImage(named:"ref.png")
...
//        self.lastUpdateTimeLabel.frame = CGRectMake(lastUpdateX, lastUpdateY, lastUpdateWidth, lastUpdateHeight);
        //状态标签
        self.statusLabel.frame = CGRectMake(statusX,(64-32)/2, statusWidth,32)
        self.backImage.frame=CGRectMake(self.frame.size.width/2-100,-70,155.5,105.5)
        self.arrowImage.frame=CGRectMake(self.backImage.frame.origin.x+30,(64-40)/2,15,40)
...
//    }
    ...
    func adjustStateWithContentOffset()
    {
        ...
        if self.scrollView.dragging{
            let normal2pullingOffsetY:CGFloat = happenOffsetY - 64
